...
public class OnboardItem extends Fragment {
    ...
    @StringRes
    private static final int[] PAGE_IMAGE = new int[]{R.drawable.onboard_one, R.drawable.onboard_two, R.drawable.onboard_three};
    @StringRes
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_onboard_item, container, false);
