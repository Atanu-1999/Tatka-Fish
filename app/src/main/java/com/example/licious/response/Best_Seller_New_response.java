...
public class Best_Seller_New_response {
    @SerializedName("data")
    @Expose
    private List<Best_Seller_Response.Datum> data;
    @SerializedName("code")
    @Expose
    private String code;
    ...
    public List<Best_Seller_Response.Datum> getData() {
        return data;
    }

    public void setData(List<Best_Seller_Response.Datum> data) {
        this.data = data;
    }
