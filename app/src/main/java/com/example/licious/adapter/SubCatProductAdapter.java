...
public class SubCatProductAdapter extends RecyclerView.Adapter<SubCatProductAdapter.ViewHolder> {
    ...
    public SubCatProductAdapter(Context context, List<SubCategoryItemResponse.Datum> ItemList, SubCategoriesProductListener listener) {
    ...
    @NonNull
    @Override
    public SubCatProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.sub_category_product, parent, false);
        SubCatProductAdapter.ViewHolder viewHolder = new SubCatProductAdapter.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull SubCatProductAdapter.ViewHolder holder, int position) {
